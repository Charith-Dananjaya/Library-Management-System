...
//** While loop for load the data
            ...
            Logger.getLogger(SM2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Search Member");
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 257, 580, 370));

        txtID.setFont(new java.awt.Font("SansSerif", 0, 18)); // NOI18N
        txtID.setForeground(new java.awt.Color(102, 102, 102));
        txtID.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtID.setText("Member ID");
        jPanel3.add(txtID, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 630, 320, 40));

        jLabel10.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(102, 102, 102));
        jLabel10.setText("Member ID");
        jPanel3.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 610, -1, -1));
